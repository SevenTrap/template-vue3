import { globalViewer as map } from "@/utils/initEarth";
...
export const posArr = [
  {
    ...
    model: "/assets/gltf/leida.glb",
  },

  {
    name: "自然资源部",
    pos: [116.364862, 39.922346, 0],
    model: "/assets/gltf/building.gltf",
  },
  {
    name: "生态环境部",
...
export function satelliteLook() {
  map.setCameraView(
    { lat: 30.560391, lng: 58.246962, alt: 4113469.4, heading: 358, pitch: -63 },
    { complete: () => lookAction() }
  );
}
